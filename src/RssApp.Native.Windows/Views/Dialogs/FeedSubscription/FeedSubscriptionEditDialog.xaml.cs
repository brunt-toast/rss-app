...
public sealed partial class FeedSubscriptionEditDialog : ContentDialog
{
    public FeedSubscriptionEditViewModel ViewModel { get; } 

    public FeedSubscriptionEditDialog(XamlRoot xamlRoot)
    {
        XamlRoot = xamlRoot;
        ViewModel = new FeedSubscriptionEditViewModel(App.Services);
